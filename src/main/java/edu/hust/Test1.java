...
//                //写入数据
//                data.writeData(tableName, booleans[a],newTableName;
...
//                //改表名
//                String sql = alter_floattable(floats[a1],tableName1);
//                System.out.println(sql);
//                if(sql!=null){
//                    baseDao.affectRowMore1(sql,1,1);
//                }
                    //更改表名
...
//                    String sql = deleteTable(newTableName);
                    baseDao.writeToMysql(sql, -1,1);
                    //写入数据
                    data.writeData(tableName1, floats[a1],newTableName);
